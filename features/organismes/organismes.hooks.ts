...
export function useCreateOrganisme() {
  ...
  return useMutation({
    mutationFn: (payload: CreateOrganismePayload) =>
      organismesService.create(payload),

    onSuccess: () => {
      toast.success('Organisme créé');
      queryClient.invalidateQueries({
        queryKey: organismesKeys.all,
      });
    },

    onError: () => {
      toast.error("Échec de la création de l'organisme");
    },
  });
}
...
export function useUpdateOrganisme() {
  ...
  return useMutation({
    mutationFn: (payload: Organisme) =>
      organismesService.update(payload),
    ...
    onError: () => {
      toast.error("Échec de la mise à jour de l'organisme");
    },
  });
}
...
export function useDeleteOrganisme() {
  ...
  return useMutation({
    ...
    onError: () => {
      toast.error("Échec de la suppression de l'organisme");
    },
  });
}