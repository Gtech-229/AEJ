...
const SEED_USERS: User[] = [
  { id: 1, nom: 'Koné', prenom: 'Awa', email: 'awa.kone@aej.ci', telephone: '+2250700000001', adresse: 'Abidjan', role_id: 1, fonction_id: 1, is_active: 1 },
  { id: 2, nom: "N'Guessan", prenom: 'Yao', email: 'yao.nguessan@aej.ci', telephone: '+2250700000002', adresse: 'Yamoussoukro', role_id: 2, fonction_id: 2, is_active: 1 },
  { id: 3, nom: 'Traoré', prenom: 'Fatou', email: 'fatou.traore@aej.ci', telephone: '+2250700000003', adresse: 'Bouaké', role_id: 3, fonction_id: 3, is_active: 0 },
  { id: 4, nom: 'Aka', prenom: 'Koffi', email: 'koffi.aka@aej.ci', telephone: '+2250700000004', adresse: 'Korhogo', role_id: 2, fonction_id: 4, is_active: 1 },
  { id: 5, nom: 'Diallo', prenom: 'Mariam', email: 'mariam.diallo@aej.ci', telephone: '+2250700000005', adresse: 'San-Pédro', role_id: 3, fonction_id: 1, is_active: 1 },
];
  ...
  create: async (payload: CreateUserPayload, client: ApiClient = apiClient): Promise<User> => {
    try {
      ...
      if (isDev) {
        ...
        const created: User = { ...rest, id: Date.now(), is_active: 1 };
  ...
  update: async (payload: UpdateUserPayload, client: ApiClient = apiClient): Promise<User> => {
    try {
      ...
      if (isDev) {
        ...
        const updated: User = { ...current, ...payload, is_active: current?.is_active ?? 1 };
